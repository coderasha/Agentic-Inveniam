...
| Documents … AI Marketplace, Analytics | `apps/platform-api` | 3003 |
| Console | `apps/web` | 3000 |

## Not built yet

Full Administration, OpenSearch, Qdrant, Neo4j production integration, live Fabric/Polygon connectors.
